...
FROM ismailbouajaja/poetry:poetry__${POETRY_VERSION}--python__${PYTHON_VERSION}--dev AS dev
...
FROM ismailbouajaja/poetry:poetry__${POETRY_VERSION}--python__${PYTHON_VERSION} AS prod
